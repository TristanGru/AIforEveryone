...
**Verify facts independently.** For anything where accuracy matters, including legal questions, medical information, statistics, and citations, don't trust AI output without verification. The model sounds confident whether it's right or wrong.
