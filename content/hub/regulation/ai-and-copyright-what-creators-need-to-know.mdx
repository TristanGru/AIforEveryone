...
This is where things get most unsettled, and most consequential.
...
AI companies argue training is transformative, creating something new rather than substituting for the original. Plaintiffs argue the opposite: the outputs directly compete with their work, and the effect on their market is real and harmful. No court has fully resolved this yet. The outcomes will set the rules for the entire industry.

## Do You Own What You Make With AI?

If you use AI as a tool rather than the other way around, you may well have copyright in the result. But you have to think carefully about how you used it.

The Copyright Office's guidance draws a line around **human creative control**. If a human makes meaningful creative choices, whether selecting, arranging, editing, or directing AI output, those choices can be protected. What the AI contributed on its own cannot.
