...
sources:
  ...
  - name: 'MIT Sloan Management Review — Measuring AI Value'
    url: 'https://sloanreview.mit.edu/article/measuring-ai-value-the-hidden-complexity'
  - name: 'Gartner — AI ROI Framework 2025'
    url: 'https://www.gartner.com/en/documents/ai-roi-framework'
relatedSlugs: []
